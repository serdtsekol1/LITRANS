...
function initMap() {
    var e = {lat: 34.0522342, lng: -118.2436849}, n = new google.maps.Map(document.getElementById("contact-map"), {center: e, scrollwheel: !1, zoom: 15});
    new google.maps.Marker({map: n, icon: "media/images/marker.png", position: e, title: "OUR LOCATON!"})
}

function sendmail_1() {
    var e = $("#gq-form").serialize();
    $.ajax({
        type: "POST", url: "sendmail.php", data: e + "&formname=get_quote", success: function (e) {
            $(".send-result").html(e)
        }
    })
}
...
function sendmail_2() {
    ...
    $.ajax({
        type: "POST", url: "sendmail.php", data: e + "&formname=contact", success: function (e) {
            $(".send-result").html(e)
        }
    })
}
...
$(window).on("load", (function () {
    var e = 1280, n = 1080;
    $(window).width() > 640 ? (e = 1280, n = 1080) : (e = 2e3, n = 1480), $("#main-slider-1").sliderPro({
        width: 2560,
        height: e,
        fade: !0,
        arrows: !1,
    ...
    var t = $("#main-slider-1").data("sliderPro");
    $(".main-slider-button-prev").on("click", (function () {
        return t.previousSlide(), !1
    })), $(".main-slider-button-next").on("click", (function () {
        return t.nextSlide(), !1
    })), $("#main-slider-2").sliderPro({width: 2560, height: n, fade: !0, arrows: !1, buttons: !1, waitForLayers: !0, autoplay: !1, autoplayDelay: 8e3, autoplayOnHover: "pause", autoScaleLayers: !1});
    var i = $("#main-slider-2").data("sliderPro");
    ...
    e("#main-slider-1").height(n / 2 + "px"), e("#show-search").on("click", (function () {
        ...
        e("#num1").animate({num: 3300-3}, {
            duration: 3e3, step: function (e) {
                this.innerHTML = (e + 3).toFixed(0)
            }
        }), e("#num2").animate({num: 147}, {
            duration: 3300, step: function (e) {
                this.innerHTML = (e + 3).toFixed(0)
            }
        }), e("#num3").animate({num: 117}, {
            duration: 3600, step: function (e) {
                this.innerHTML = (e + 3).toFixed(0)
            }
        }), e("#num4").animate({num: 11}, {
            duration: 3900, step: function (e) {
                this.innerHTML = (e + 3).toFixed(0)
            }
        })
    })), e("#home-stats").scrollSpy());
    var t = document.getElementById("aboutvideo"), i = e("#play-video"), o = e("#stop-video");
    i.on("click", (function () {
        return t.play(), i.css("display", "none"), o.css("display", "block"), !1
    })), o.on("click", (function () {
        return t.pause(), o.css("display", "none"), i.css("display", "block"), !1
    })), e("#owl-review").owlCarousel({items: 1, itemsDesktop: [1e3, 1], itemsDesktopSmall: [900, 1], itemsTablet: [600, 1]});
    var a = e("#owl-clients");
    a.owlCarousel({items: 1, itemsDesktop: [1e3, 1], itemsDesktopSmall: [900, 1], itemsTablet: [600, 1], pagination: !1}), e("#next-clients").on("click", (function () {
        return a.trigger("owl.next"), !1
    })), e("#prev-clients").on("click", (function () {
        return a.trigger("owl.prev"), !1
    })), e("#left-menu").metisMenu({toggle: !1}), e("#show-menu").on("click", (function () {
